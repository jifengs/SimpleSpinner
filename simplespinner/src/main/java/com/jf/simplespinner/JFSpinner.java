...
public class JFSpinner extends AppCompatTextView {
    ...
    private JFSpinnerBaseAdapter adapter;
    ...
    public JFSpinner(Context context) {
        super(context);
        init(context, null);
    }

    public JFSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public JFSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.JFSpinner);
        ...
        backgroundSelector = typedArray.getResourceId(R.styleable.JFSpinner_backgroundSelector, R.drawable.selector);
        setBackgroundResource(backgroundSelector);
        textColor = typedArray.getColor(R.styleable.JFSpinner_textTint, getDefaultTextColor(context));
        ...
        isArrowHidden = typedArray.getBoolean(R.styleable.JFSpinner_hideArrow, false);
        arrowDrawableTint = typedArray.getColor(R.styleable.JFSpinner_arrowTint, Integer.MAX_VALUE);
        arrowDrawableResId = typedArray.getResourceId(R.styleable.JFSpinner_arrowDrawable, R.drawable.arrow);
        dropDownListPaddingBottom =
                typedArray.getDimensionPixelSize(R.styleable.JFSpinner_dropDownListPaddingBottom, 0);
        typedArray.recycle();
    ...
    public <T> void attachDataSource(List<T> list) {
        adapter = new JFSpinnerAdapter<>(getContext(), list, textColor, backgroundSelector,
                spinnerTextFormatter);
        setAdapterInternal(adapter);
    }

    public void setAdapter(ListAdapter adapter) {
        this.adapter = new JFSpinnerAdapterWrapper(getContext(), adapter, textColor, backgroundSelector,
                spinnerTextFormatter);
        setAdapterInternal(this.adapter);
    }

    private void setAdapterInternal(JFSpinnerBaseAdapter adapter) {
